...
<div class="mt-4">
    ...
    <div>
        <h2>Cadernos</h2>
    <!-- route('admin.cadernos.edit',$caderno) -->        
    <!-- php artisan route:list -->        
        <a href="/admin/cadernos/create"
        ...
        <table class="table table-hover table-striped">
            <thead class="text-center">
                <tr>
                    ...
                    <th colspan="3" class="w-25">Ações</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- route('admin.cadernos.show',$caderno) -->
                    ...
                    <td>
                        <!-- php artisan route:list -->
                        <a href="/admin/cadernos/{{$caderno->id}}/edit"
...
<script>
    ...
    .addEventListener('show.bs.modal',function(event){
        ...
        form.action = "/admin/cadernos/" + noticiaId;
    });
</script>
@endsection